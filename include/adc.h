...
static const std::array<adc_channel_t, NB_CHANNELS> ADC_CHANNELS = {
    ADC_CHANNEL_9, ADC_CHANNEL_8, ADC_CHANNEL_0, ADC_CHANNEL_1, ADC_CHANNEL_3,
    ADC_CHANNEL_4, ADC_CHANNEL_5, ADC_CHANNEL_6, ADC_CHANNEL_7, ADC_CHANNEL_2
};  // Keep ADC1_2 (pin3) need to be free to use JTAG
